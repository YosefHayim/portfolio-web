...
export function SkeletonTitle({ className }: SkeletonProps) {
 return <ShimmerSkeleton className={cn("h-8 w-3/4", className)} />;
}

export function SkeletonAvatar({ className }: SkeletonProps) {
 return <ShimmerSkeleton className={cn("h-16 w-16 rounded-full", className)} />;
}

export function SkeletonCard({ className }: SkeletonProps) {
 return (
 <div className={cn("space-y-4 rounded-lg bg-gray-800/50 p-2", className)}>
