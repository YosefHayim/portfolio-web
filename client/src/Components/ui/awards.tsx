...
export function Awards({
 ...
 >
 <defs>
 <path d={createTextPath(55)} fill="none" id="top-curve" />
 <path
 d={createTextPath(60)}
 fill="none"
 id="bottom-curve"
 ...
 {recipient && (
 <div className=" text-[14px] text-[#05df72]">{recipient}</div>
 )}
 {date && (
 ...
 <div
 className={cn(
 " inline-block rounded-md p-2 p-2 tracking-wider text-white",
 ...
 <div className="mx-auto h-[1px] w-40 bg-[#05df72]" />

 <h2 className=" w-60 text-xl font-light text-(--text-secondary)">
 {subtitle}
 </h2>
 ...
 const Badge = () => (
 <svg
 className=" h-18 w-full overflow-hidden fill-[#05df72]"
 height="24"
 viewBox="0 0 24 24"
 width="24"
 >
 ...
 >
 <div className="z-10 rounded-sm border border-[var(--border-subtle)] bg-[var(--bg-card)] p-2 p-2 text-center">
 <Badge />
 <h1 className=" grid text-3xl leading-7 font-bold tracking-tighter text-[var(--text-primary)] uppercase">
 Certificate
 ...
 <h1 className=" border-b border-[var(--border-subtle)] text-xl font-semibold tracking-tight text-[#05df72]">
 {recipient}
 </h1>
 ...
 {link && (
 <div className=" flex items-center justify-center gap-2 text-xs text-[#00d9ff]">
 ...
 <div
 className={cn(
 "flex justify-start gap-2 rounded-md border-4 border-[var(--border-subtle)] p-2",
 )}
 >
 <BadgeSvg />
 <div className="border-l border-[var(--border-subtle)] p-2">
 ...
 >
 <div className="flex items-center gap-2 p-2 sm:flex-col sm:p-2">
 ...
 {customIcon || <Award className="text-[#05df72]" size={24} />}
 </div>
 ...
 <div className=" flex flex-wrap items-center gap-2 gap-2 text-xs sm:justify-center">
 {platform && (
 ...
 {link && (
 <div className=" flex items-center gap-2 text-[11px] text-[var(--text-muted)] transition-colors group-hover:text-[#05df72] sm:justify-center">
 <span>View Certificate</span>
