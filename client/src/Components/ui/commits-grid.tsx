...
export const CommitsGrid = ({ text }: { text: string }) => {
 ...
 return (
 <section
 className="grid w-full max-w-[280px] gap-2 rounded-[10px] border bg-[var(--bg-card)] p-2 sm:max-w-md sm:gap-2 sm:rounded-[15px] sm:p-2 md:max-w-xl lg:max-w-2xl xl:max-w-3xl"
 style={{
