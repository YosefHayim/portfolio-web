...
export function Awards({
      ...
      >
        ...
        >
          ...
          <path
            ...
            strokeWidth="0.2"
            className="fill-[var(--bg-card)] stroke-[#05df72]"
          />
          ...
          <text className="fill-[#05df72] text-xl font-bold">
        ...
        <div className="relative z-10 text-center">
          {showIcon && (
            <div className="mb-1 flex justify-center text-center text-2xl">
              {customIcon || <Star className="fill-[#05df72] text-[#05df72]" />}
            </div>
          )}
          {recipient && (
            <div className="mt-2 text-[14px] text-[#05df72]">{recipient}</div>
          )}
          {date && (
    ...
    return (
      ...
      >
        ...
        <div className="z-10 px-8 text-center">
          ...
          <div className="mx-auto my-3 h-[1px] w-40 bg-[#05df72]"></div>

          <h2 className="mb-4 w-60 text-xl font-light text-[var(--text-secondary)]">
            {subtitle}
          </h2>

          {recipient && <p className="text-[#05df72]/60 italic">{recipient}</p>}
    ...
    const content = (
      ...
      >
        <div className="z-10 rounded-sm border border-[var(--border-subtle)] bg-[var(--bg-card)] p-6 px-8 text-center">
          ...
          <p className="mt-4 mb-1 text-xs text-[var(--text-muted)]">
            This is to certify that
          </p>
          <h1 className="mb-2 border-b border-[var(--border-subtle)] text-xl font-semibold tracking-tight text-[#05df72]">
            {recipient}
          </h1>

          <p className="mb-1 text-xs text-[var(--text-muted)]">{subtitle}</p>
          <div className="mt-6 flex justify-center">
            <Award strokeWidth={1} className="h-4 w-4 text-[#05df72]" />
          </div>
          ...
          {link && (
            <div className="mt-4 flex items-center justify-center gap-1 text-xs text-[#00d9ff]">
  ...
  if (variant === 'badge') {
    ...
    return (
      <div className={cn('', className)}>
        ...
        >
          <BadgeSvg />
          <div className="border-l border-[var(--border-subtle)] px-3">
            <h1 className="text-4xl font-bold tracking-tight text-[#05df72]">
              {title}
            </h1>
            <h2 className="text-md font-light text-[var(--text-muted)]">
              {subtitle}
            </h2>
  ...
  // Modern Card Variant (Custom for our UI)
  if (variant === 'modern-card') {
    const content = (
      <div
        className={cn(
          'group relative overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-5 transition-all duration-300',
          link &&
            'cursor-pointer hover:border-[#05df72]/50 hover:bg-[var(--bg-card-hover)] hover:shadow-lg hover:shadow-[#05df72]/5',
          className
        )}
      >
        {/* Gradient accent */}
        <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[#05df72] via-[#00d9ff] to-[#05df72] opacity-60" />

        <div className="flex items-start gap-4">
          {/* Icon */}
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-[var(--bg-surface)] text-[#05df72] transition-all duration-300 group-hover:bg-[#05df72]/10 group-hover:shadow-[0_0_20px_rgba(5,223,114,0.2)]">
            {customIcon || <Award size={24} />}
          </div>

          {/* Content */}
          <div className="min-w-0 flex-1">
            <h3 className="mb-1 line-clamp-2 font-semibold text-[var(--text-primary)] transition-colors group-hover:text-[#05df72]">
              {title}
            </h3>
